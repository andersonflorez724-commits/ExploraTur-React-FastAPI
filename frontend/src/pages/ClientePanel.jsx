 ...
 * Acceso solo para clientes autenticados. Usa el mismo sidebar que Admin y Empleado.
 */
function ClientePanel() {
  ...
  return (
    <DashboardLayout
      navItems={navItems}
      activeSection={tab}
      onSectionChange={(id) => { setTab(id); setError('') }}
      title={sectionTitle[tab]}
      subtitle="Consulta tu información, productos y servicios disponibles."
      accentColor="emerald"
    >
